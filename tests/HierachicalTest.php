...
class HierachicalTest extends TestCase
{
    ...
    public function testDecorateArbitraryPsr11Container()
    {
        ...
        $this->assertEquals('aic_foo_content', $container->get('aic_foo'),
            "Container does not return the correct value for 'aic_foo'");
    }
    ...
    public function testDecorateArbitraryPsr11ContainerAlias()
    {
        ...
        $this->assertEquals('aic_foo_content', $container->get('foo'),
            "Container does not return the correct value for alias 'foo'");
    }
